"""OCT Alveo U280 profile with post-boot script (supports custom (Vivado) workflow)
"""
...
pc.defineParameter("node", "Node",
                   portal.ParameterType.STRING,
                   nodeList[0], nodeList,
                   longDescription="The custom workflow only allows the nodes that are listed here.")
